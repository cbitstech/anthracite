...
if (fetch(:stage) == :staging) || (fetch(:stage) == :vagrant)
...
NameVirtualHost *:443
<VirtualHost *:80>
  ServerName anthracite-staging.cbits.northwestern.edu
  Redirect permanent / https://anthracite-staging.cbits.northwestern.edu/
</VirtualHost>
<VirtualHost *:443>
...
NameVirtualHost *:443
<VirtualHost *:80>
  ServerName anthracite.northwestern.edu
  Redirect permanent / https://anthracite.northwestern.edu/
</VirtualHost>
<VirtualHost *:443>
  PassengerFriendlyErrorPages off
  ...
  <Directory #{ fetch(:deploy_to) }/current/public >
    ...
    EOF
    vagrant_vhost_config = <<-EOF
NameVirtualHost *:80
NameVirtualHost *:443
<VirtualHost *:80>
  ServerName anthracite
  Redirect permanent / https://anthracite
</VirtualHost>
<VirtualHost *:443>
  PassengerFriendlyErrorPages off
